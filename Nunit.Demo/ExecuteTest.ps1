...
$rawCoverageFolder = "C:\code\nunit-demo\Nunit.Demo\Nunit.Demo.Test\TestResults";
...
Copy-Item -Path C:\code\nunit-demo\Nunit.Demo\Nunit.Demo.Test\TestResults\TestResults.xml -Destination C:\code\nunit-demo\Nunit.Demo\Reports

#Generate html coverage report
C:\Users\hrida\.nuget\packages\reportgenerator\4.5.6\tools\netcoreapp3.0\ReportGenerator.exe -reports:C:\code\nunit-demo\Nunit.Demo\Reports\coverage\coverage.xml -vernosity:Info -targetdir:C:\code\nunit-demo\Nunit.Demo\Reports\coverage
